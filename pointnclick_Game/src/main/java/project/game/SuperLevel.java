...
/**
 * Implements logic of a level Controller.
 */
public abstract class SuperLevel extends SuperController implements ILevel {
    ...
    private static boolean firstGameLoad = true;
    ...
    /**
     * "
     * @param button loads scene "InsideFridge" to find the 4 image minigame
     */

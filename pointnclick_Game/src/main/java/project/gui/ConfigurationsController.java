...
public class ConfigurationsController extends SuperController implements Initializable {
    ...
    /**
     * This method sums up the randomization of images for each category and its color.
     * @param image of the category that is being changed.
     * @param urlImages of the images available. Selection to change them to.
     * @param baseImgURL original Image of that style to change its color.
     * @param colorGrid of the color selection from that category.
     * @param category label of the category.
     * @param categoryIndex current index of the category.
     * @param isGender whether or not that category is gender based.
     */
    ...
    public void loadTutorialPopup(){
        loadPopUp(SceneSwitchItems.Scenes.TUTORIAL.getFXMLURL(), container, player, 723, 563);
    }

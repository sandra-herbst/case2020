...
public class TutorialController extends SuperController implements Initializable {
    ...
    private final String[] explanationGifURL = {  "/img/tutorial/configs.gif","/img/tutorial/collectItem.gif","/img/tutorial/save.gif",
     ...
     * leftButton and @param rightButton, so one can click through different tutorial instructions
     * index works like a counter and determines which page you are on
     * explanationGifUrl includes all paths to the required GIFs,

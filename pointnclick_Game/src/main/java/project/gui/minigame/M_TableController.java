...
public class M_TableController extends SuperController implements Initializable {
     ...
     */
    private void clickListenerReset(int index) {
        setClickableScale();
        setCounterZero();
     ...
     */
    private void replaceInventoryItem(String key) {
    ...
    private void loadAnimationPopup() {
        AnchorPane ownerPane = (AnchorPane) ((Stage) container.getScene().getWindow()).getOwner().getScene().getRoot();
